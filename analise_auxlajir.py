...
def processar_contabeis():
    ...
    # Novas contas de interesse
    contas_alvo = ["35", "36", "45", "47"]
...
def main():
    ...
    # 3. Realiza as subtrações solicitadas (Passos Intermediários)
    df_pivot['Resultado Financeiro Líquido'] = df_pivot['35'] - df_pivot['45']
    df_pivot['Resultado Patrimonial'] = df_pivot['36'] - df_pivot['47']
    
    # 4. Cálculo do Resultado Final
    df_pivot['Resultado Final'] = df_pivot['Resultado Financeiro Líquido'] + df_pivot['Resultado Patrimonial']
    ...
    out_file = f"base_fin_patrimonial_dinamica_{ts}.xlsx"
