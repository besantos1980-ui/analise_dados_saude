...
def processar_contabeis():
    ...
    # Contas de interesse para o cálculo de X
...
def main():
    print("Iniciando extração dos dados contábeis para cálculo de X...")
    ...
    # 2. Garante que todas as contas existam como colunas para evitar erro de cálculo
    contas_alvo = ["314", "315", "443", "43", "46", "415", "416"]
    ...
    # X = (Soma das receitas 314/315) - (Soma das despesas/outros 443, 43, 46, 415, 416)
    ...
    out_file = f"base_calculo_X_{ts}.xlsx"
